...
def normalize_path_params(cidade=None, estrelas_min=0,estrelas_max=5, diaria_min=0, diaria_max=100000, limit=50,offset = 0,
        **dados
):
...
# path /hoteis?cidade=Rio de Janeiro&estelas_min=4%diaria_max=400
